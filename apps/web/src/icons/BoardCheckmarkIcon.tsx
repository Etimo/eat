...
type BoardCheckmarkIconProps = Omit<IconBaseProps, 'children'>;
export const BoardCheckmarkIcon: FC<BoardCheckmarkIconProps> = (props) => {
  return (
    <IconBase {...props}>
...
BoardCheckmarkIcon.displayName = 'BoardCheckmarkIcon';
