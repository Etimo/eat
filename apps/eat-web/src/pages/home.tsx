...
export const HomePage = () => {
  ...
  const getRowColor = (index: number) => {
    switch (index) {
      ...
      case 1: return 'bg-slate-300/10 hover:bg-slate-300/20';
      case 2: return 'bg-amber-700/10 hover:bg-amber-700/20';
          ...
          <TableBody>
            {data?.map((team, index) => (
              ...
              >
                ...
                <TableCell className={`font-semibold ${index < 3 ? 'text-lg' : ''}`}>
                  {team.name}
                </TableCell>
                <TableCell>
                ...
                <TableCell>
                  <span className={`font-bold ${index < 3 ? 'text-xl text-yellow-500' : 'text-lg'}`}>
