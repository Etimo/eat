...
export class Migration20240222133138 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `activities` (`id` varchar(36) not null, `created_at` varchar(255) not null, `updated_at` varchar(255) not null, `name` varchar(255) not null, `time` int not null, `date` varchar(255) not null, `activity_type_id` varchar(36) not null, `user_id` varchar(36) not null, primary key (`id`)) default character set utf8mb4 engine = InnoDB;');
